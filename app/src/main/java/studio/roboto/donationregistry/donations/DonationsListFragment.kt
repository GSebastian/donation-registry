...
class DonationsListFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?,
        ...
        if (view is RecyclerView) {
            ...
            view.adapter = MyDonationRecyclerViewAdapter(DummyContent.ITEMS, mListener)
        }
        return view
    }
    ...
    companion object {
        ...
        fun newInstance(columnCount: Int): DonationsListFragment {
            val fragment = DonationsListFragment()
            val args = Bundle()
